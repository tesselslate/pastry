 ...
 */
public final record PreemptiveFrame(@NotNull PastryCaptureFrameEvent frame, @NotNull PastryCaptureOptionsEvent options,
        @NotNull PastryCaptureProfilerEvent profiler, @Nullable PastryCaptureBlockOutlineEvent blockOutline,
        @NotNull PastryCaptureEntityEvent[] entities, @NotNull PastryCaptureBlockEntityEvent[] blockEntities) {
    /**
    ...
    public boolean isPure() {
        return this.entities == null && this.blockEntities.length == 1
                && this.blockEntities[0].name.equals("mob_spawner") && this.blockEntities[0].data.equals("silverfish");
    }
}
